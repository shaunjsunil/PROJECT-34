...
function setup() {
  ...
  hero = new Hero(400,350,250);
  rope = new Rope(hero.body, { x: 390, y: 90 });
  ...
  box25 = new Box(740, 100, 70, 70);
  box26 = new Box(740, 100, 70, 70);
  box27 = new Box(740, 100, 70, 70);
  box28 = new Box(740, 100, 70, 70);
  ...
  box21 = new Box(670, 100, 70, 70);
  box22 = new Box(670, 100, 70, 70);
  box23 = new Box(670, 100, 70, 70); 
  box24 = new Box(670, 100, 70, 70); 
